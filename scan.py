...
if __name__ == "__main__":
    ...
    ap.add_argument("-image_name", help="File name to be scanned")
...
#Extract text from processed image using pytesseract trained on english dataset

result_txt = pytesseract.image_to_string(Image.open('output/'+im_file_name),lang='eng')
print(result_txt)



lst = list()
lst = result_txt.split()
lst1 = lst
x1 = 0

lst_total = ("TOTAL", "total", "TOTL", "Total")
